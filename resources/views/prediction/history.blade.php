...
@section('title', 'Prediction History - LiverCare AI')
    ...
    <div class="max-w-7xl mx-auto">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            <div>
                ...
                <p class="text-gray-400 mt-2">Your complete history of AI predictions</p>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <div class="glass-card rounded-xl border border-gray-800 p-4">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-gray-400 text-sm">High Risk Cases</p>
...
<div id="deleteModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 backdrop-blur-sm">
    <div class="bg-gray-900 rounded-2xl border border-gray-800 p-6 max-w-md w-full mx-4">
        <div class="text-center">
            ...
            <h3 class="text-xl font-bold text-white mb-2">Delete Prediction</h3>
            <p class="text-gray-400 text-sm mb-6">Are you sure you want to delete this prediction? This action cannot be undone.</p>
            <div class="flex gap-3">
                ...
                <form id="deleteForm" method="POST" action="">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="px-6 py-2 bg-red-600 rounded-lg hover:bg-red-500 transition">
                        Delete
                    </button>
                </form>
            </div>
